    ...
    <div className="font-poppins border border-b-2 border-light-gray">
      <div className="flex flex-col sm:flex-row items-center bg-filter p-4 pl-8 sm:pl-16 pr-8 sm:pr-16 relative mb-8">
        <div className="flex items-center mb-4 sm:mb-0">
          ...
          <a href='/shop' className="text-gray ml-4">Shop</a>
        ...
        <div className="w-full sm:w-1/2 sm:pl-8 mt-8 sm:mt-0">
          ...
          <div className="flex items-center mb-4">
            <div className="flex items-center">
              ...
              <div className="bg-gray h-6 w-0.5 ml-8 mr-4"></div>
              <span className="ml-2 text-gray">{product.customers} Customer Reviews</span>
            </div>
          </div>
          <div className="mb-4">
            ...
            <div className="flex items-center flex-wrap">
              {product.size.map((size, index) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-md mr-2 mb-2 sm:mb-0 ${selectedSize === size ? 'bg-primary text-white' : 'bg-filter'}`}
                >
                  {size}
                </button>
              ))}
            ...
            <div className="flex items-center">
              {product.colors.map((color, index) => (
                <img
                  ...
                  src={color}
                  alt={`Color ${index}`}
                  className={`w-8 h-8 mr-2 cursor-pointer ${selectedColor === index ? 'scale-125' : ''}`}
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start mt-10">
            <div className="flex flex-col sm:mr-4">
              ...
              <div className="flex items-center mb-20">
                ...
                <div className="flex">
                  <a href="https://www.facebook.com/" target="_blank" className="mr-4">
                    <img src="https://desafio3furniro.s3.us-east-2.amazonaws.com/product/facebook.png" alt="Facebook" />
                  </a>
                  <a href="https://www.linkedin.com/" target="_blank" className="mr-4">
                    <img src="https://desafio3furniro.s3.us-east-2.amazonaws.com/product/linkedin.png" alt="LinkedIn" />
                  </a>
                  <a href="https://x.com/" target="_blank">
                    <img src="https://desafio3furniro.s3.us-east-2.amazonaws.com/product/twitter.png" alt="Twitter" />
                  </a>
                </div>
              </div>
            </div>
